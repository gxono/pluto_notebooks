...
# ╔═╡ 801c0b6e-70a8-45ae-b2b8-ac16f4ac0b7a
@htl "<div style='text-align: right'><em>Jonatan Perren (jperren@fce.unl.edu.ar)</em></div>"
...
begin
	...
	Columns(
		...
		md"Tamaño de la muestra $(@bind n_muestra PlutoUI.Slider(1:50, default=25, show_value=true))"
	)
end
...
begin
	...
	Columns(
		...
		md"Tamaño de la muestra $(@bind n_muestrab PlutoUI.Slider(1:50, default=25, show_value=true))"
	)
end
...
begin
	...
	Columns(
		...
		md"Tamaño de la muestra $(@bind n_muestrac PlutoUI.Slider(1:50, default=25, show_value=true))"
	)
end
...
manifest_format = "2.0"
project_hash = "25bb7cdd7811b0ddbcd0ad59dae7c1b798ded2ef"
